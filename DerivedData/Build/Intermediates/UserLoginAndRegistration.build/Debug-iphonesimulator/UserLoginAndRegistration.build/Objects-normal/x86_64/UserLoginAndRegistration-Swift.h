...
- (IBAction)homeClicked:(id _Nonnull)sender;
- (IBAction)hotClicked:(id _Nonnull)sender;
- (IBAction)catClicked:(id _Nonnull)sender;
- (IBAction)imClicked:(id _Nonnull)sender;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
