...
SWIFT_CLASS("_TtC24UserLoginAndRegistration27CatagoryTableViewController")
@interface CatagoryTableViewController : ForumTableViewController
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (NSInteger)numberOfSectionsInTableView:(UITableView * _Nonnull)tableView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC24UserLoginAndRegistration17CommentDataSource")
...
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified CellCommentImage;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified cellCommentLabel;
...
SWIFT_CLASS("_TtC24UserLoginAndRegistration8Download")
...
SWIFT_CLASS("_TtC24UserLoginAndRegistration16DownloadComments")
@interface DownloadComments : NSObject
@property (nonatomic, copy) NSArray * _Nullable dataFromServer;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS("_TtC24UserLoginAndRegistration15ForumDataSource")
...
SWIFT_CLASS("_TtC24UserLoginAndRegistration18ForumTableViewCell")
...
SWIFT_CLASS("_TtC24UserLoginAndRegistration15UserInformation")
